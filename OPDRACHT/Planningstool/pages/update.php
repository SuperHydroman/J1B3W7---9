...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($playersErr) && empty($explainerErr) && empty($timeErr) && empty($gameIDErr)) {
        ...
        updateGame($players, $explainer, $time, $gameID, $id);
                ...
                <div id="form">
                    <form method="POST" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]), "?gameID=".$getPlannedGame['gameID']."&id=".$getPlannedGame['id'];?>">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="players" type="text" class="form-control" id="players" placeholder="Wie spelen er mee?" value="<?= $getPlannedGame['players'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="explainer" type="text" class="form-control" id="explainer" placeholder="Wie legt het spel uit?" value="<?= $getPlannedGame['explainer'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="time" type="time" class="form-control" id="time" placeholder="Hoelaat?" value="<?= $getPlannedGame['time'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-sm-10">
                                <input name="gameID" type="text" class="form-control" id="gameID" value="<?= $getPlannedGame['gameID'] ?>">
                            </div>
                        </div>
